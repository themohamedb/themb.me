...
echo ""
echo "→ Vercel is deploying automatically from this push."
echo "  Deployments: https://vercel.com/mohamed-s-projects-3e49e0b6/themb/deployments"
echo "  Live site:   https://themb.me (updates in ~30–60s after build finishes)"
